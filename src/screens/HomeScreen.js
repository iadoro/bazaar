...
export default function HomeScreen() {
  return (
    <Tab.Navigator>
      ...
      <Tab.Screen name="YourProfileScreen" component={YourProfileScreen} options={{ headerShown: true, title: "Profile", headerTitleAlign: "center", tabBarShowLabel: false, tabBarShowLabel: false, tabBarIcon: ({ focused, color, size }) => <Icon name="user" size={20} color="#581F18" /> }} />
    </Tab.Navigator>
  );
}