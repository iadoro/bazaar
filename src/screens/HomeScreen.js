...
export default function HomeScreen({ navigation }) {
  return (
    <Tab.Navigator>
      <Tab.Screen name="FeedScreen" component={FeedScreen} options={{ headerShown: true, title: "Home", headerTitleAlign: "center", tabBarShowLabel: false, tabBarIcon: ({ focused, color, size }) => <Icon name="list-alt" size={20} color="#581F18" /> }} />
